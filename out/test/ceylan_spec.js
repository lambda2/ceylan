(function() {
  ...
  Feature("New Feature", "In order to use cool feature", "as a new user", "I want do include this", function() {
    return Scenario("Init", function() {
      var voice;
      voice = null;
      Given("I create a new object", function() {});
      When("I create", function() {
        console.log(Ceylan);
        return ceylan = new ceylan.Ceylan();
      });
      return Then("it should be an object", function() {
        return ceylan.should.be.a('object');
      });
    });
  });
